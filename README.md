...
- не скрывает историю прошлых месяцев при переходе на новый месяц: в Google Sheets лист `Показатели` строится по накопленной истории из локальной базы, начиная с `2026-04-01`;
...
- автоматическое обновление отчета по базам пересинхронизирует Битрикс за период `2026-04-01`..`today`, чтобы при сбоях расписания не оставались дыры в конце месяца;
